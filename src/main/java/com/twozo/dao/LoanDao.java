...
public interface LoanDao {
	...
	boolean removeLoan(final String loanNumber) throws LoanNotFoundException;

	boolean loanSanction(final String accountNumber, final double amount) throws InsufficientAmount, AccountNotFoundException, DatabaseException;

	Loan getLoanDetails(final String loanId) throws LoanNotFoundException;

	boolean repayLoanAmount(final String loanId, final double loanBalance) throws LoanNotFoundException;

	boolean updateLoanDetails(final String updateData, final String loanId, final String updateType)
			throws LoanProcessingException, DuplicateUpdateException, LoanNotFoundException, DatabaseException, InvalidCustomerUpdateException;

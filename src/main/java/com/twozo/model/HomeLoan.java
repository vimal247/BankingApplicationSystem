...
public class HomeLoan extends Loan {
	...
	public HomeLoan(final String loanholdername, final String accountNumber, final double loanAmount,
			...
			final HomeLoan homeLoan, final double income, final EmploymentType employementType, final double interestRate,
	...
	public String toString() {
		...
		return "HomeLoan [Loan Number : " + getLoanNumber() + ", Loan Holder Name : " + getCustomer().getName()
				...
				+ ", Employement Type : " + employementType + ", Bank Statement Url : " + bankStatementUrl
	...
	public void setEmployementType(final EmploymentType employementType) {
		this.employementType = employementType;
	}

...
public class LoanDaoCollectionImpl implements LoanDao {	
	...
	@Override
	public final boolean repayLoanAmount(final String loanNumber, final double loanBalance) throws InsufficientAmount {
	...
	@Override
	public final boolean loanSanction(final String accountNumber, final double amount)
	...
	private boolean updateCustomerDob(final String dob, final String accountNumber) throws LoanProcessingException {
		Customer customer;
		try {
			customer = ACCOUNT_DAO.getAccountByNumber(accountNumber).getCustomer();

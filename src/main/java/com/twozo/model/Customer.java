...
public final class Customer {
	...
	private Customer(final long customerId, final String name, final Gender gender, 
	...
	public Customer(final String name, final Gender gender, final String mobileNumber, 
					final String aadharNumber, final String panCardNumber ,final LocalDate dob, 
					final String address, final String photoUrl) {
		this(0, name, gender, mobileNumber, aadharNumber, panCardNumber, dob,
				address, photoUrl);
	}

...
public class CustomerDaoCollectionImpl implements CustomerDao {
	...
	@Autowired
	public CustomerDaoCollectionImpl(final AccountDaoCollectionImpl accountDao) {
	...
	@Override
	public final Customer getCustomerByAccountNumber(final String accountNumber) throws AccountNotFoundException, DatabaseException {
	...
	public boolean updateCustomerDetails(final String updateData, final String accountNumber, final String updateType)
            throws InvalidCustomerNameException, DuplicateEntryException, DatabaseException, AccountNotFoundException {
	...
	private boolean updateDetail(final String updateData, final String identity, final String updateType)
            throws DuplicateEntryException, DatabaseException, AccountNotFoundException {
	...
	private  CustomerDaoCollectionImpl() {
